      ...
      body: Stack(
        children: <Widget>[
           Positioned(
              ...
              child: Text(
                'Valley-I',
                style: TextStyle(fontSize: 48.r, fontFamily: 'Marker', fontWeight: FontWeight.normal, color: Colors.white),
              )),
          Positioned(
              ...
              child: Text(
                'Login',
                style: TextStyle(fontSize: 40.h, fontFamily: 'Pacific', fontWeight: FontWeight.w500, color: Colors.white),
              )),
